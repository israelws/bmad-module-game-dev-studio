...
<action>Search {planning_artifacts}/ for file: bmgd-workflow-status.yaml</action>
...
<action>Read {planning_artifacts}/bmgd-workflow-status.yaml if exists</action>
...
<action>Check if {planning_artifacts}/bmgd-workflow-status.yaml exists</action>
...
<action>Read {planning_artifacts}/bmgd-workflow-status.yaml</action>
