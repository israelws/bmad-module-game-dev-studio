...
- `project_levels` = `{project-root}/_bmad/bmgd/workflows/workflow-status/project-levels.yaml`

### Related Workflows

- `quick_spec_workflow` = `{project-root}/_bmad/bmgd/workflows/bmad-quick-flow/quick-spec/workflow.md`
